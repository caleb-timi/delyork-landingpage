...
export default function Communications() {
  return (
    ...
    <section className="subsidiary-hero">
      <div className="subsidiary-copy"><span className="section-kicker">Del-York Communications</span><h1>Innovative solutions in PR, branding, and storytelling.</h1><p>Del-York Communications is a creative agency focused on public relations, strategic communications, content creation, digital solutions, branding, marketing, and media production.</p><div className="subsidiary-actions"><a href="/#subsidiaries" className="hero-link">Back to ecosystem</a><a href="https://delyorkcommunications.com/" className="hero-link" target="_blank" rel="noopener">Visit Communications</a></div></div>
    ...
    <section className="subsidiary-section alt"><div className="related-subsidiaries"><span className="section-kicker">Explore more</span><div className="related-grid"><a className="related-link" href="/subsidiaries/creative-academy">Creative Academy</a><a className="related-link" href="/subsidiaries/life-africa">LIFE Africa</a><a className="related-link" href="/subsidiaries/technology">Del-York Technologies</a><a className="related-link" href="/subsidiaries/reskill-africa">Re-Skill Africa</a></div></div></section>
