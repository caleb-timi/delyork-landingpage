...
export default function Reskillafrica() {
  return (
    ...
    <section className="subsidiary-hero">
      <div className="subsidiary-copy"><span className="section-kicker">Re-Skill Africa</span><h1>Building the workforce that will build the continent.</h1><p>Re-Skill Africa is an industrial talent and enterprise development system built around AI-powered learning, real production environments, the Skildustry Model, and a blockchain-verified Skill Passport.</p><div className="subsidiary-actions"><a href="/#subsidiaries" className="hero-link">Back to ecosystem</a><a href="https://www.reskillafrica.org/" className="hero-link" target="_blank" rel="noopener">Visit Re-Skill Africa</a></div></div>
    ...
    <section className="subsidiary-section alt"><div className="related-subsidiaries"><span className="section-kicker">Explore more</span><div className="related-grid"><a className="related-link" href="/subsidiaries/creative-academy">Creative Academy</a><a className="related-link" href="/subsidiaries/life-africa">LIFE Africa</a><a className="related-link" href="/subsidiaries/communications">Del-York Communications</a><a className="related-link" href="/subsidiaries/technology">Del-York Technologies</a></div></div></section>
